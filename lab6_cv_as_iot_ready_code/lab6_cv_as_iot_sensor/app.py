...
def motion_capture(source: str, seconds: int = 8, threshold: int = 25, min_area: int = 800) -> Dict[str, Any]:
    ...
    if motion_detected:
        person_detected = detect_person(best_frame)
    if motion_detected and person_detected:
        ...
        motion_event = {
            ...
            "severity": "CRITICAL",
            "explanation": "Motion detected and MediaPipe found a human body.",
            "action_hint": "Show alarm on dashboard."
        }
        ...
        motion_event = {
            ...
            "score": round(best_score, 2),
            "severity": "NORMAL",
            "explanation": "Movement detected but no person found.",
            "action_hint": "Ignore."
        }
        ...
        motion_event = {
            ...
            "score": round(best_score, 2),
            "severity": "NORMAL",
            "explanation": "No movement detected.",
